...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join("artifacts","preprocessor.pkl") # we save prepocesser to .pkl file
    ...
    def get_data_transformer_object(self):
        try:
            ...
            num_pipeline= Pipeline(
                steps=[
                ("imputer",SimpleImputer(strategy="median")),   #imputer is responsible to handle missing values
